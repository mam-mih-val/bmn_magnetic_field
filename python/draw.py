...
def main(argv):
    ...
    for y in unique_y:
        ...
        ax.set_ylim([-6, 15])
        plt.text(0.1, 0.85, 'Nx = ' + str(len(x_values)), horizontalalignment='left', verticalalignment='center', transform=ax.transAxes)
        plt.legend()
        pp.savefig(fig)
        plt.cla()
        plt.clf()
    ...
    for x in unique_x:
        ...
        ax.set_ylim([-6, 15])
        plt.text(0.1, 0.85, 'Ny = ' + str(len(y_values)), horizontalalignment='left', verticalalignment='center', transform=ax.transAxes)
        plt.legend()
        pp.savefig(fig)
        plt.cla()
        plt.clf()
